...
import { processPortfolioData, generateAIInsightsForBalances, ProcessedPortfolioData } from "./PortfolioSummaryUtils";
...
const PortfolioSummary: React.FC = () => {
  ...
  const loadPortfolio = useCallback(async (showToast = true) => {
    try {
      ...
      const portfolioData = processPortfolioData(accountInfo, prices, symbols);
  ...
  const generateAIInsights = async () => {
    ...
    try {
      const enhancedBalances = generateAIInsightsForBalances(balances);
